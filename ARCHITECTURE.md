...
1. **Offline-first before cloud-first.**
2. **Zero-latency audio before code sharing.**
3. **Child experience over developer convenience.**
4. **Backend is the single source of truth.**
5. **APIs are platform-agnostic.**
6. **Media is cached locally before use.**
7. **Every architectural decision must preserve accessibility.**

## Current Production Architecture

For a child relying on AAC, communication cannot be dependent on Wi-Fi or cellular networks. Therapy centers often have poor connectivity, and emergencies in public spaces require immediate access to communication tools. Therefore, **during child interaction, the local SQLite database becomes the authoritative runtime data source, ensuring the communication experience remains completely independent of network availability.**
...
3. **Local Storage (The Authoritative Source):** 
...
### 5. Scalable Backend (Django & PostgreSQL)
